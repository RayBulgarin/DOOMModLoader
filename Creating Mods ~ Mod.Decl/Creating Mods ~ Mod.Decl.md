...
### `modLoaderVersion`
If your mod has a "*mod.decl*" file, this is required. Specifies which DOOMModLoader version this mod is made for. Example: `modLoaderVersion = "0.5";`
